        ...
        <div className="flex items-center justify-center px-4 py-12">
          <div className="w-full max-w-md">
            <div className="glass rounded-3xl shadow-soft-lg p-6 sm:p-8 text-center border border-gray-200/50 dark:border-gray-700/50">
              ...
              <h1 className="text-3xl font-heading font-bold mb-4 gradient-text">
                Check your email!
              </h1>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full px-6 py-3 bg-gradient-primary text-white rounded-2xl hover:opacity-90 transition-all duration-300 font-semibold shadow-soft-lg hover:shadow-glow"
                >
                  Resend Email
                </button>
                <Link
                  href="/auth/login"
                  className="block w-full px-6 py-3 glass text-gray-700 dark:text-gray-300 rounded-2xl hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-300 font-semibold text-center shadow-soft"
                >
                  Back to Login
                </Link>
              </div>
      ...
      <div className="flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="glass rounded-3xl shadow-soft-lg p-6 sm:p-8 border border-gray-200/50 dark:border-gray-700/50">
            <h1 className="text-3xl sm:text-4xl font-heading font-bold text-center mb-2 gradient-text">Sign Up</h1>
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-300/50 dark:border-gray-600/50 rounded-2xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 bg-white/50 dark:bg-gray-800/50 text-gray-900 dark:text-white transition-all shadow-soft"
                />
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">Minimum 6 characters</p>
              </div>
              <button
                type="submit"
                disabled={loading}
            ...
            <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/auth/login" className="text-primary-600 dark:text-primary-400 hover:underline font-semibold transition-colors">
                Login
              </Link>
            </p>
          </div>
