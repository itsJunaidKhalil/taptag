                  ...
                  <Link
                    ...
                    className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center gap-1.5 ${
                      pathname?.startsWith("/admin")
                        ...
                        : "text-amber-700 dark:text-amber-300 hover:bg-amber-50 dark:hover:bg-amber-900/20 border border-amber-200 dark:border-amber-900/40"
                    }`}
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {profile?.role === "admin" && (
                  <Link
                    ...
                    className={`block px-4 py-2 rounded-xl text-base font-semibold transition-all ${
                      pathname?.startsWith("/admin")
                        ? "bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-glow"
                        : "text-amber-700 dark:text-amber-300 border border-amber-200 dark:border-amber-900/40"
                    }`}
                  >
                    Admin
                  </Link>
